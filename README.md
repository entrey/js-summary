...
<details>
  <summary>2.2. Higher-order Functions</summary>
...
<details>
  <summary>2.3. Differences between .call and .apply</summary>
...
```(function () { /* ... */ })()```
 ...
 - The second ```()``` creates the IIFE through which the JavaScript engine will directly interpret the function.
</details>
...
<details>
  <summary>3.1. Bubbling and capturing</summary>
...
<details>
  <summary>3.2. Event delegation</summary>
